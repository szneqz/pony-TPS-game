...
Shader "Custom/MaskColorMenu" {
	Properties{
		_Color1("hair_BG", Color) = (1,1,1,1)
		_Color2("hair_one", Color) = (1,1,1,1)
		_Color3("hair_two", Color) = (1,1,1,1)
		_Color4("body", Color) = (1,1,1,1)
		_Color5("eyes", Color) = (1,1,1,1)
		//	_ColorClear ("Color", Color) = (0.1, 0.1, 0.1, 1)
		_MainTex("Albedo (RGB)", 2D) = "white" {}
	_GSTex("GrayScale", 2D) = "white" {}
	_CMTex("CM", 2D) = "white" {}
	_MaETex("Mouth_Eyes", 2D) = "white" {}
	_MaskTex_1a("Tail", 2D) = "white" {}
	_MaskTex_1b("BackHair", 2D) = "white" {}
	_MaskTex_1c("FrontHair", 2D) = "white" {}
	_MaskTex_2("Body & Eyes", 2D) = "white" {}
